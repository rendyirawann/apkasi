...
@push('stylesheets')
    <style>
        ...
        .apkasi-event-badge {
            ...
            color: #17C653;
            border: 1px solid rgba(23, 198, 83, 0.25);
            border-radius: 30px;
            padding: 6px 16px;
            font-size: 0.8rem;
            font-weight: 700;
        ...
        .apkasi-input-icon .form-control {
            padding-left: 46px;
        }

        .apkasi-aside {
            background: linear-gradient(160deg, #0b5e2a 0%, #17C653 55%, #3ee27e 100%);
            position: relative;
            overflow: hidden;
        }
...
@section('content')
    <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-start p-12">
        ...
        <div class="apkasi-login-card bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10 shadow-lg">

            <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">

                <div class="d-flex flex-center flex-column flex-column-fluid mb-2">
                    <img alt="HUT Ke-26 APKASI" class="mw-100 h-90px h-lg-130px mb-5"
                        src="{{ asset('logos/hut-apkasi-2026.png') }}" />

                    <span class="apkasi-event-badge mb-4">
                        <i class="ki-outline ki-calendar fs-6"></i> 1 &ndash; 3 Juli 2026
                    </span>

                    <h1 class="text-gray-900 fw-bold fs-2qx text-center mb-2">Masuk Panel Admin</h1>
                    <div class="text-gray-500 fw-semibold fs-6 text-center">
                        Kelola konten &amp; informasi acara HUT APKASI
                    </div>
                </div>
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20 my-12">
                    ...
                    <form class="form w-100" id="kt_sign_in_form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="fv-row mb-6 apkasi-input-icon">
                        ...
                        <div class="fv-row mb-3 position-relative apkasi-input-icon" data-kt-password-meter="true">
                            <i class="ki-outline ki-lock"></i>
                            <input type="password" placeholder="Password" name="password" autocomplete="off"
                                class="form-control form-control-solid" id="passwordInput" />
