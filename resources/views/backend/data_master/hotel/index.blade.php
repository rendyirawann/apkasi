            ...
            <form id="hotelForm">
                <div class="modal-body py-6 px-lg-10">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <label class="fw-semibold fs-7 mb-1">Link Gambar <span class="text-muted">(opsional)</span></label>
                            <input type="text" name="image" id="h_image" class="form-control form-control-solid" placeholder="https://..." />
                            <div class="text-danger fs-8 mt-1" data-error="image"></div>
                        </div>
                        <div class="col-md-12">
...
<script>
    ...
    const FIELDS = ['nama','alamat','ketersediaan_kamar','rating','urut','contact_wa','contact_email','lat','lng','maps_url','image'];
    let mode = 'create';
