...
class LandingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            'lp_hero_leaders_img'      => 'assets/apkasi/leaders.png',
            // Kolaborasi
            ...
            // Banner di atas peta tab Rental (halaman Panduan) — 2 slot tetap (edit/hapus gambar + tampil/sembunyikan)
        ...
        if (SiteLogo::count() === 0) {
            $logos = [
                ...
                ['hero_v2', 'logos/hut26-outline.png', 'HUT Ke-26 APKASI'],
                ['hero_v2', 'logos/hutds80-outline.png', 'HUT Ke-80 Deli Serdang'],
                ['hero_v3', 'logos/aoe2026.png', 'APKASI Otonomi Expo'],
                ['hero_v3', 'logos/poi-outline.png', 'Putri Otonomi Indonesia'],
        ...
        $heroCarousel = [
            ...
            ['hero_v2', 'logos/hut26-outline.png', 'HUT Ke-26 APKASI', 1],
            ['hero_v2', 'logos/hutds80-outline.png', 'HUT Ke-80 Deli Serdang', 2],
            ['hero_v3', 'logos/aoe2026.png', 'APKASI Otonomi Expo', 1],
            ['hero_v3', 'logos/poi-outline.png', 'Putri Otonomi Indonesia', 2],
        ];
